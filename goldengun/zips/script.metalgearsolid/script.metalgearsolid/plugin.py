	...
	def __init__(self):
		...
		for info in self.infos:
			...
			for key, value in items:
				thumb_path  = 'special://home/addons/script.metalgearsolid/resources/skins/Default/media/tmdb/thumb.png'
				fanart_path = 'special://home/addons/script.metalgearsolid/resources/skins/Default/media/tmdb/fanart.jpg'
				url = 'plugin://script.metalgearsolid?info=%s&limit=0' % key
			...
			for key, value in NoFolder_items:
				thumb_path  = 'special://home/addons/script.metalgearsolid/resources/skins/Default/media/tmdb/thumb.png'
				fanart_path = 'special://home/addons/script.metalgearsolid/resources/skins/Default/media/tmdb/fanart.jpg'
				url = 'plugin://script.metalgearsolid?info=%s' % key
				li = xbmcgui.ListItem(label=value)
				li.setArt({'thumb': thumb_path, 'fanart': fanart_path})
