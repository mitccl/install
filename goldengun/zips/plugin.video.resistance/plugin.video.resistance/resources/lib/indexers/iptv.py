...
class indexer:
    ...
    def root(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F316D656E752E786D6C'.decode('hex')
    ...
    def rootalltv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F416C6C5054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootcinematv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F43696E656D61495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootfaithtv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F4661697468495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootlodgetv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F4C6F646765495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootradiotv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F526164696F495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootsportplugins(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F73706F7274706C7567732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootmytv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F4D79497074762E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root4kmovies(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F346B2E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root1kmovies(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F313038302E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootdtsmovies(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F6474732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootkids(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F6B6964732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootXXX(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F6164756C742E6D3375'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
    ...
    def root_1click(self): # Real Debrid
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F616C6C2E72642E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootnlmovie(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F346B6865726F2E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootnltvshow(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F346B72642E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootvipclick(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F31636C69636B2E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootextinfo(self):
        try:
            regex.clear()
            url = '68747470733A2F2F617263686976652E6F72672F646F776E6C6F61642F31636C69636B5F3230323030312F6F70656E6D6574615F6D656E752E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
