...
elif action == 'metSettings':
    from resources.lib.modules import control
    control.openSettings(id='plugin.video.metalgear')   
...
elif action == 'tmdbliteNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().tmdb(lite=True)	

elif action == 'TMDBMovies':
    from resources.lib.indexers import navigator
    navigator.navigator().TMDBMovies()
	
elif action == 'TMDBShows':
    from resources.lib.indexers import navigator
    navigator.navigator().TMDBShows()
...
elif action == 'nanscrapersettings'    : xbmcaddon.Addon('script.module.openscrapers').openSettings()
