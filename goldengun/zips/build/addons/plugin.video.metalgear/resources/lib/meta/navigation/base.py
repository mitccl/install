...
def get_background_path():
    if plugin.get_setting(SETTING_BACKGROUND, unicode) == "Matching": return os.path.join('https://github.com/Goldengunrepo/Style/raw/master/metalgear/backgrounds/', str(plugin.get_setting(SETTING_STYLE, unicode).lower()) + ".png")
    ...
    else: return os.path.join('https://github.com/Goldengunrepo/Style/raw/master/metalgear/backgrounds/', str(plugin.get_setting(SETTING_BACKGROUND, unicode).lower()) + ".png")

def get_banner_path():
    return 'https://github.com/Goldengunrepo/Style/raw/master/metalgear/default/banner.jpg'
