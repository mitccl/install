...
module_path = xbmc.translatePath(('special://home/addons/script.module.resistancescrapers')).decode('utf-8')


def main():
    fum_ver = xbmcaddon.Addon(id='script.module.resistancescrapers').getAddonInfo('version')
