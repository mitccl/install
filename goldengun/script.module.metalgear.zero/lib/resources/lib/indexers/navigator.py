...
class navigator:
    def root(self):
    	self.addDirectoryItem('[COLOR red][I]WELCOME TO METALGEAR[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
    	self.addDirectoryItem('[COLOR red][I]METALGEAR MOVIE SECTION[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    	self.addDirectoryItem('[COLOR pearl][I]--------------------------------------------------[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
    	self.addDirectoryItem('[COLOR yellow][I]METALGEAR TV SHOWS SECTION[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    	self.addDirectoryItem('[COLOR pearl][I]--------------------------------------------------[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
