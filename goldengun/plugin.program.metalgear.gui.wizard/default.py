...
BUILDS   = os.path.join(ART , 'builds1.png')
BUILDS2  = os.path.join(ART , 'builds2.png')
CLOSE    = os.path.join(ART , 'close.png')
CLOSE1   = os.path.join(ART , 'close1.png')
...
def BuildList():
	...
	if not BUILDFILE == 'http://' and not BUILDFILE == '':
		...
		window.placeControl(buildthumb, 21, 30, 45, 11)
...
def AddonList():
	...
	if not ADDONFILE == 'http://' and not ADDONFILE == '':
		...
		window.placeControl(addthumb, 31, 30, 45, 11)
...
def APKList():
	...
	if not APKFILE == 'http://' and not APKFILE == '':
		...
		window.placeControl(apkthumb, 31, 30, 45, 11)
...
def EmuList():
	...
	if not EMUAPKS == 'http://' and not EMUAPKS == '':
		...
		window.placeControl(emuthumb, 31, 30, 45, 11)
...
def RomList():
	...
	if not ROMPACK == 'http://' and not ROMPACK == '':
		...
		window.placeControl(romthumb, 31, 30, 45, 11)
...
def Installables():
	...
	ROMButton = pyxbmct.Button('[COLOR %s][B][/B][/COLOR]' % OTHER_BUTTONS_TEXT,)
	window.placeControl(ROMButton,12 , 250 ,  7, 8)
	window.connect(ROMButton, lambda: RomList())
	
	EmuButton = pyxbmct.Button('[COLOR %s][B][/B][/COLOR]' % OTHER_BUTTONS_TEXT,)
	window.placeControl(EmuButton,12 , 330 ,  7, 8)
...
#buttons/objects
BuildsButton= pyxbmct.Button('[COLOR %s][B][/B][/COLOR]' % MAIN_BUTTONS_TEXT, focusTexture=BUILDS2,noFocusTexture=BUILDS)
...
InstallablesButton = pyxbmct.Button('[COLOR %s][B]Applications[/B][/COLOR]' % MAIN_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
window.placeControl(InstallablesButton,2 , 33, 9, 8)
window.connect(InstallablesButton, lambda: Installables())

CloseButton = pyxbmct.Button('[COLOR %s][B][/B][/COLOR]' % MAIN_BUTTONS_TEXT,focusTexture=CLOSE,noFocusTexture=CLOSE1)
