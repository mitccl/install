...
base='http://metalportals.com'    #HERE YOU NEED TO INPUT YOUR WEB URL HTTP://MYWEBSPACE.NET
ADDON=xbmcaddon.Addon(id='plugin.program.metalgear.injector')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR lime]Metalgear Injector[/COLOR]","[COLOR orange]Downloading[/COLOR] ",'', '[COLOR orange]Please Wait[/COLOR]')
    ...
    addonfolder = xbmc.translatePath(os.path.join('special://home/userdata/','addon_data/plugin.video.metalgear/Movies/'))
    time.sleep(2)
    dp.update(0,"", "[COLOR lime]Injecting your file's[/COLOR]")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("[COLOR orange]Injection Complete[/COLOR]", '[COLOR lime]Please Update Your Library Either From Library Updater Program Or The Context Menu In Your Library Press OK To Continue......[/COLOR]')
    killxbmc()



def killxbmc():
	xbmc.executebuiltin("ActivateWindow(10025,'plugin://service.libraryautoupdate/',return)")
    ...
    #print "Platform: " + str(myplatform)
        ...
        #except: pass
        #dialog.ok("[COLOR=red][B]WARNING  !!![/COLOR][/B]", "If you\'re seeing this message it means the force close", "was unsuccessful. Please force close XBMC/Kodi [COLOR=orange]DO NOT[/COLOR] exit cleanly via the menu.",'')
