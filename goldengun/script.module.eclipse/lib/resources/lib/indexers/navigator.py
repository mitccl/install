...
class navigator:
    def root(self):
        self.addDirectoryItem('4K', 'lists', '4k.png', 'DefaultMovies.png')
        self.addDirectoryItem('1 Click', 'lists2', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem('Films', 'movieNavigator', '2.png', 'DefaultMovies.png')
        self.addDirectoryItem('Series', 'tvNavigator', '3.png', 'DefaultTVShows.png')

        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem('My Films', 'mymovieNavigator', '9.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('My Series', 'mytvNavigator', '10.png', 'DefaultVideoPlaylists.png')

        if not control.setting('movie.widget') == '0':
            self.addDirectoryItem('New Films', 'movieWidget', '8.png', 'DefaultRecentlyAddedMovies.png')

        if (traktIndicators == True and not control.setting('tv.widget.alt') == '0') or (traktIndicators == False and not control.setting('tv.widget') == '0'):
            self.addDirectoryItem('New Series', 'tvWidget', '7.png', 'DefaultRecentlyAddedEpisodes.png')
        ...
        self.addDirectoryItem('Find', 'searchNavigator', '5.png', 'DefaultFolder.png')
    ...
    def mymovies(self, lite=False):
        ...
        if lite == False:
            self.addDirectoryItem(32031, 'movieliteNavigator', '5.png', 'DefaultMovies.png')
            self.addDirectoryItem(32028, 'moviePerson', '5.png', 'DefaultMovies.png')
            self.addDirectoryItem(32010, 'movieSearch', '5.png', 'DefaultMovies.png')
    ...
    def search(self):
        self.addDirectoryItem(32001, 'movieSearch', '5.png', 'DefaultMovies.png')
        self.addDirectoryItem(32002, 'tvSearch', '5.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32029, 'moviePerson', '5.png', 'DefaultMovies.png')
        self.addDirectoryItem(32030, 'tvPerson', '5.png', 'DefaultTVShows.png')
