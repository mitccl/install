...
class Main:
    ...
    def __init__(self):
        ...
        xbmc.executebuiltin('SetProperty(metalgearsolid_running,True,home)')
        ...
        if self.infos:
            ...
            for key, value in iter(sorted(movie_items.iteritems())):
                ...
                li.setProperty('fanart_image', "special://home/addons/script.metalgearsolid/resources/skins/Default/media/%s-fanart.jpg" % image_code)
                if SCRIPT == "true" and "yt" not in value: url = 'plugin://script.metalgearsolid?info=%s&type=script' % key
                else: url = 'plugin://script.metalgearsolid?info=%s' % key
        ...
        xbmc.executebuiltin('ClearProperty(metalgearsolid_running,home)')
